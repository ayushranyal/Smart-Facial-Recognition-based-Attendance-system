...
Press C(or c) for quit this window. After quitting it, attendance of person will be stored in the Attendance folder as CSV file with name format DD-MM-YYYY_Timing__Attendance.csv. Inside the file, Id, Time, and Name.

To terminate the project, click the End button.
